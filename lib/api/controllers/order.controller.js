...
function create(req, res, next) {
  ...
  productCtrl.calculateOrderPrice(req.sanitize(req.body.entries))
    .then( (calculatedPrice) => {
      return {
        entries: req.sanitize(req.body.entries),
    ...
    .then( (orderTemplate) => {
      if (userId !== undefined) {
        ...
        orderTemplate.customer = req.sanitize(req.body.customer);
